...
id = '6938430246' #Replace This
tok = '7380021050:AAEyaXubiDUddeKQAi0UIJlUql5cFsCPujg' #Replace This
zzk = 0
...
ـ @f_r_3_a_o_n'''
    ...
    but1 = types.InlineKeyboardButton(text='᥉᥆ᥙᖇᥴᥱ ƒᖇᥲ᥆ꪀ', url='https://t.me/sorcefraon')
    but2 = types.InlineKeyboardButton(text='ƒᖇᥲ᥆ꪀ', url='https://t.me/f_r_3_a_o_n')
